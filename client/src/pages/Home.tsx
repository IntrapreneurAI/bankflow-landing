            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <Card className="p-8">
                <div className="flex flex-col items-center text-center">
                  ...
                  <h3 className="text-2xl font-bold mb-2">John Sokol</h3>
                  <p className="text-cyan-600 font-medium mb-4">Data Scientist & AI Advisor</p>
                  
                  <div className="text-left w-full space-y-3 mb-6">
                    <p className="text-muted-foreground">
                      Data scientist with 5 years of experience in machine learning, AI systems, and data analytics. Brings technical expertise in AI model validation and performance monitoring.
                    </p>
                    
                    <div className="space-y-2">
                      <div className="flex items-start gap-2">
                        <CheckCircle2 className="h-5 w-5 text-cyan-600 flex-shrink-0 mt-0.5" />
                        <span className="text-sm">5+ years in data science and machine learning</span>
                      </div>
                      <div className="flex items-start gap-2">
                        <CheckCircle2 className="h-5 w-5 text-cyan-600 flex-shrink-0 mt-0.5" />
                        <span className="text-sm">Expert in AI model validation and monitoring</span>
                      </div>
                      <div className="flex items-start gap-2">
                        <CheckCircle2 className="h-5 w-5 text-cyan-600 flex-shrink-0 mt-0.5" />
                        <span className="text-sm">Technical advisor for AI governance frameworks</span>
                      </div>
                    </div>
                  </div>
